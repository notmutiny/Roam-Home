-- Global table -- ADD REST OF KEYBIND REDIRECTS
RoamHome={
    ver=1.1,
    ...
    local optionsData = {
        [1] = {
         ...
         [7] = {
            type = "dropdown",
            name = " Secondary home",
            tooltip = "Only works if primary is set to first /home",
            width = "half",
            choices = self.savedhousestrings,
            ...
            controls= { -- START FRIEND SETTINGS --
               ...
               [3] = {
                ...
                [4] = {
                    ...
                    tooltip = "Disabled for 1.0 am soz - Save a memorable name for this home",
                    width = "full",
                    getFunc = function() return end,
